      ...
      <main className="grid min-h-full place-items-center bg-white text-black px-6 sm:py-32 lg:px-8 dark:bg-[#3A3A3A] dark:text-slate-50 h-screen">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link
              to="/"
              className="rounded-md bg-green-700 text-slate-50 px-3.5 py-2.5 text-sm font-semibold  shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
            >
              {t("home")}
            </Link>
          </div>
