          ...
          <div className="md:flex">
            ...
            <div className="md:w-2/3 p-4">
              <div className="flex justify-between items-start">
                ...
                <HeartIcon product={product as any} />
              </div>
              ...
              {product.countInStock > 0 && (
                <div className="my-4">
                  ...
                  <select id="quantity" value={qty} onChange={e => setQty(parseInt(e.target.value))} className="block w-full p-2 border border-gray-300 rounded-md shadow-sm">
